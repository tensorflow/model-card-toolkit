...
"""Tests for for Model Card JSON schema utilities."""
...
class JsonUtilsTest(parameterized.TestCase):
  ...
  def test_validate_json_schema(self):
    json_utils.validate_json_schema(_MODEL_CARD_V1_DICT,
                                    schema_version="0.0.1")
    json_utils.validate_json_schema(_MODEL_CARD_V2_DICT, schema_version="0.0.2")
  ...
  def test_json_update_succeeds(self):
    ...
    with self.subTest(name=_QUANTITATIVE_ANALYSIS):
      ...
      v1_graphics_updated = updated_cats_vs_dogs_dict.get(
          _QUANTITATIVE_ANALYSIS).get("graphics")
      v2_graphics = _CATS_VS_DOGS_V2_DICT.get(_QUANTITATIVE_ANALYSIS).get(
          "graphics")
      ...
      v1_metrics_updated = updated_cats_vs_dogs_dict.get(
          _QUANTITATIVE_ANALYSIS).get("performance_metrics")
      v2_metrics = _CATS_VS_DOGS_V2_DICT.get(_QUANTITATIVE_ANALYSIS).get(
          "performance_metrics")
