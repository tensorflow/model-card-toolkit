...
* `ModelCardArtifact`, a TFX/MLMD artifact which references the assets generated by MCT.
* `save_mlmd()`, a function that saves a ModelCard artifact to a MLMD store.
